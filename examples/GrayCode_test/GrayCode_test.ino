/*
    ...
    Each board has 2 16 position encoders
...
#define SHIFT_LATCH 3   // pin that loads current positions into the register(s)
...
void loop() {
  ...
  // you can access the pos array to get encoder positions even if they are the same.
